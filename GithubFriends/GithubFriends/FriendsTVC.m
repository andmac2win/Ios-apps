...
- (void)viewDidLoad {
    ...
    friends = [@[
        ...
        @"repos_url":@"",
        @"id": @10392740,
        @"avatar_url": @"https://avatars.githubusercontent.com/u/10392740?v=3",
        @"name": @"Andrew McDonald",
        @"company": @"",
        @"blog": @"",
        @"location": @"Atlanta Ga",
        @"email": @"mothershipya@yahoo.com",
        @"public_repos": @1,
        @"public_gists": @0,
        @"followers": @3,
        @"following": @4,
...
// this is method to create listen for touch "make the app slide into another VC"1111111111111111111111111
